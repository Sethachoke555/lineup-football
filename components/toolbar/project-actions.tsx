...
export function ProjectActions({ project, onLoad, notify, intro=false }: { project: Project; intro?: boolean; onLoad: (project: Project) => void; notify: (message: string) => void }) {
